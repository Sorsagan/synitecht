        ...
        .addSubcommand((subcommand) =>
          subcommand
            ...
            .addStringOption((option) =>
              option.setName("string").setDescription("String to send")
            )
            .addUserOption((option) =>
              option.setName("user2").setDescription("User to ping 2")
            )
        )
    )
    .addSubcommand((subcommand) =>
      subcommand.setName("message").setDescription("Message subcommand")
    )
    .toJSON(),
